<template>
  <div>
    <div style="display: inline-block; min-width: 90%">
      ...
      <div class="father">
        <el-image
          style="width: 600px; height: 400px;position: absolute;z-index: 15"
          :src="scene.cover"
          v-show="play"
          @click="handlePlay"
          fit="cover"/>
        <img src="../../assets/playButton.png" v-show="play" @click="handlePlay">
        <video id="video" controls="controls" style="width: 600px; height: 400px" :poster="scene.cover">
      ...
      <div style="float: left; height: 60px;clear:right;margin-left: 80px;margin-top: 50px">
        ...
        <span style="font-size: 20px">{{scene.scenedate}}</span><br>
